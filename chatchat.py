...
def process_llm_response(llm_response, prompt):
...
.sidebar .stMarkdown {
    height: calc(100vh - 8rem); /* Adjust the height as needed */
    overflow-y: auto;
}
</style>
"""
...
# Get the user's question from a text input widget.
